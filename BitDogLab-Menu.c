...
int main()
{
  ...
  while (true)
  {
    ...
    ssd1306_line(&ssd, 3, 37, 123, 37, cor); // Desenha uma linha 
     ssd1306_line(&ssd, 3, 47, 123, 47, cor); // Desenha uma linha   
//    ssd1306_draw_string(&ssd, "Sistema  S.O.S", 8, 6); // Desenha uma string
  //  ssd1306_draw_string(&ssd, "Opcao 01", 20, 16); // Desenha uma string
 //   ssd1306_draw_string(&ssd, "JOYSTICK", 10, 28); // Desenha uma string 
